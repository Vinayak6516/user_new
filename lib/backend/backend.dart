...
import 'schema/collectors_record.dart';
...
export 'schema/collectors_record.dart';
...
/// Functions to query CollectorsRecords (as a Stream and as a Future).
Future<int> queryCollectorsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CollectorsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CollectorsRecord>> queryCollectorsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CollectorsRecord.collection,
      CollectorsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CollectorsRecord>> queryCollectorsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
